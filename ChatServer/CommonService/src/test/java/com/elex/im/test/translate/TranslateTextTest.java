//package com.elex.im.test.translate;
//
...
//		// Supported languages
//		List<String> languages = Arrays.asList("Afrikaans", "Albanian", "Amharic", "Arabic", "Armenian", "Azerbaijani",
...
//				"Haitian", "Hausa", "Hawaiian", "Hebrew", "Hindi", "Hmong", "Hungarian", "Icelandic", "Igbo",
...
//				"Pashto", "Persian", "Polish", "Portuguese", "Punjabi", "Romanian", "Russian", "Samoan", "Scots",
...
//
//	@Test
//	public void testSupportedLanguagesTargetFrench() throws Exception {
//		// Supported languages
//		List<String> languages = Arrays.asList("Afrikaans", "Albanais", "Allemand", "Amharique", "Anglais", "Arabe",
//				"Arménien", "Azéri", "Basque", "Bengali", "Biélorusse", "Birman", "Bosniaque", "Bulgare", "Catalan",
//				"Cebuano", "Chichewa", "Chinois (simplifié)", "Chinois (traditionnel)", "Cingalais", "Coréen", "Corse",
//				"Créole haïtien", "Croate", "Danois", "Espagnol", "Espéranto", "Estonien", "Finnois", "Français",
...
//				"Italien", "Japonais", "Javanais", "Kannada", "Kazakh", "Khmer", "Kirghiz", "Kurde", "Laotien", "Latin",
//				"Letton", "Lituanien", "Luxembourgeois", "Macédonien", "Malaisien", "Malayalam", "Malgache", "Maltais",
//				"Maori", "Marathi", "Mongol", "Néerlandais", "Népalais", "Norvégien", "Ouzbek", "Pachtô", "Panjabi",
//				"Persan", "Polonais", "Portugais", "Roumain", "Russe", "Samoan", "Serbe", "Sesotho", "Shona", "Sindhî",
//				"Slovaque", "Slovène", "Somali", "Soundanais", "Suédois", "Swahili", "Tadjik", "Tagalog", "Tamoul",
//				"Tchèque", "Telugu", "Thaï", "Turc", "Ukrainien", "Urdu", "Vietnamien", "Xhosa", "Yiddish", "Yorouba",
//				"Zoulou");
//
//		// Arrange
//		ByteArrayOutputStream bout = new ByteArrayOutputStream();
...
//
//	@Test
//	public void testEnglishLangDetection() throws Exception {
//		// Arrange
//		ByteArrayOutputStream bout = new ByteArrayOutputStream();
//		PrintStream out = new PrintStream(bout);
//
...
//
//		// Assert
//		Double confidence = Double.parseDouble(got.split("confidence=")[1].split("}")[0]);
...
//
//	@Test
//	public void testDefaultIdentityTranslation() throws Exception {
//		// Arrange
//		ByteArrayOutputStream bout = new ByteArrayOutputStream();
//		PrintStream out = new PrintStream(bout);
//
