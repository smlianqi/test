 ...
 *
 */
public class NettyWebSocketStartClient {
	...
	private static void sendtest(int id) throws Exception {
		NettyWebSocketStartClient start = new NettyWebSocketStartClient();
	...
	public INetNettyClient createNettyClient(String host, int port) throws URISyntaxException {
		NettyWebSocketClient nettyClient = new NettyWebSocketClient(1);
