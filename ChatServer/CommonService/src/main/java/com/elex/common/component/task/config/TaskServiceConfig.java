...
public class TaskServiceConfig extends AServiceConfig {
	private ScTask sc = new ScTask();

	public TaskServiceConfig(ServiceFileConfig serviceFileConfig, IFunctionServiceConfig functionServiceConfig) {
