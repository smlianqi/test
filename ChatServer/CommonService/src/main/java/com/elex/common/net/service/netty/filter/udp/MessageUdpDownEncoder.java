 ...
 *
 */
public class MessageUdpDownEncoder extends ChannelOutboundHandlerAdapter {
	protected static final ILogger logger = XLogUtil.logger();

	public MessageUdpDownEncoder() {
	}
	...
	public void write(ChannelHandlerContext ctx, Object message, ChannelPromise promise) throws Exception {
		...
		if (message instanceof ICommandMessage) {
			...
			if (logger.isWarnEnabled()) {
				logger.warn("[MessageUdpDown Encoder] unknown type!!! class=" + message.getClass());
			}
		}
	}
