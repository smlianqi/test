...
public class ThreadBoxServiceConfig extends AServiceConfig {
	private ScThreadbox sc = new ScThreadbox();

	public ThreadBoxServiceConfig(ServiceFileConfig serviceFileConfig, IFunctionServiceConfig functionServiceConfig) {
