...
public class ByteConvert {
	...
	public static byte[] stringToBytesUTF(String str) throws UnsupportedEncodingException {
		return str.getBytes("utf-8");
	}

	public static String bytesToStringUTF(byte[] bytes) throws UnsupportedEncodingException {
