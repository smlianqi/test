 ...
 * 任务服务配置 实体类
 */
public class ScThreadpoolGeneral implements ISpread, IWriteReadable {
	/**
	 * 唯一id
	 */
	protected String id;
