...
public class TimeoutServiceConfig extends AServiceConfig {
	private ScTimeout sc = new ScTimeout();

	public TimeoutServiceConfig(ServiceFileConfig serviceFileConfig, IFunctionServiceConfig functionServiceConfig) {
	...
	private void init() {
		...
		sc.setExpression(getProperty("expression"));
