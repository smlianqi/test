 ...
 *
 */
public class NettyHttpNetServerService extends ANettyServerService {
	public NettyHttpNetServerService(IServiceConfig serviceConfig, IGlobalContext globalContext,
