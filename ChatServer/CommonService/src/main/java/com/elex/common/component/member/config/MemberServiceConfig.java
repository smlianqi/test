...
public class MemberServiceConfig extends AServiceConfig {
	private ScMember sc = new ScMember();

	public MemberServiceConfig(ServiceFileConfig serviceFileConfig, IFunctionServiceConfig functionServiceConfig) {
