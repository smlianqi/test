...
public class EventServiceConfig extends AServiceConfig {
	private ScEvent sc = new ScEvent();

	public EventServiceConfig(ServiceFileConfig serviceFileConfig, IFunctionServiceConfig functionServiceConfig) {
	...
	private void init() {
		...
		sc.setThreadCount(Integer.parseInt(getProperty("thread_count")));
		sc.obtainAfter();
	}
