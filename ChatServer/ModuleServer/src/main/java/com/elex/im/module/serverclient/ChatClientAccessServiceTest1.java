...
public class ChatClientAccessServiceTest1 {
	public static void main(String[] args) {
		...
		ProtoReqCallBackTest1 callBack = new ProtoReqCallBackTest1(service);
		...
		service.sendUserLogin(ChatTestManger.userId2, UserType.Client, LanguageType.zh_Hans);
